...
void CanopenObject::addNode(QString nodeId){
    ...
    item.insert("1008_00", QVariantMap{{"index", 0x1008}, {"subIndex", 0x00}, {"name", tr("manufacturer device name")}, {"access", "RO"}, {"defaultValue", "Sanhua-RJM"}, {"type", "string"}, {"dlc", 20}, {"unit", ""}, {"oldValue", ""}, {"currentValue", ""}, {"pendingValue", ""}});
    ...
    item.insert("100A_00", QVariantMap{{"index", 0x100A}, {"subIndex", 0x00}, {"name", tr("Manufacturer software version")}, {"access", "RO"}, {"defaultValue", ""}, {"type", "string"}, {"dlc", 20}, {"unit", ""}, {"oldValue", ""}, {"currentValue", ""}, {"pendingValue", ""}});
